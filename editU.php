...
<body>
    ...
    <form method ="POST" action ="edithelper.php">
        <p style="font-size: 30px; color: #4CAF50"><strong>Edit users</strong></p>
        <p style="color: #4CAF50">Click an user you want to edit on th table!, and change the information.</p>
        <label for="name">The user you want to edit:</label><br>
        <P style ="font-size: 40px;"id="username"></P>
...
function selectRow() {
    for(var i =1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
            ...
            document.getElementById("username").innerHTML = this.cells[0].innerHTML;
