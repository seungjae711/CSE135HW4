...
<body>
    ...
    <script type="text/javascript">
        ...
        function downloadPDF() {
            ...
            var newCanvas = document.querySelector('#canvas6');
            ...
            doc.setFontSize(15);
            doc.text(10, 7, "Events");
            doc.addImage(newCanvasImg, 'JPEG', 10, 10, 280, 150 );
            doc.save('eventData.pdf');
            var pdf = btoa(doc.output()); 
            $.post("ClientEvents.php", 
            {
                data: pdf,
                N : name,
                E : email,
    ...
    <script type="text/javascript" src="App/appEv.js"></script>
